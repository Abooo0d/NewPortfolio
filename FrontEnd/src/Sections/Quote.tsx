  ...
  return (
    <div className="w-screen h-screen relative snap-start bg-black ">
      ...
      <div className=" absolute inset-0 w-full h-screen bg-black/40 flex flex-col justify-center items-center">
        ...
        <motion.div
          className="w-full flex-1 flex flex-col justify-center items-center text-center lg:text-[35px] text-[26px] lg:max-w-[60vw] max-w-[95%] font-semibold flex-wrap text-stone-300 cursor-default"
