...
const Footer = () => {
  return (
    <section className="bg-black min-h-screen h-full w-screen snap-end flex flex-col md:flex-row gap-4 min-[1100px]:gap-0 justify-between items-center lg:px-[100px] px-4 py-8 lg:py-0 relative">
      ...
      <img
        ...
        className="absolute bottom-[0px] right-[50%] invisible min-[1100px]:visible translate-x-[50%] h-[600px] object-contain z-10"
      />
      <div className="min-[1100px]:min-w-[35%] flex-1 min-[1100px]:flex-0 h-[60%] rounded-[20px] p-[1px] z-0 relative bg-stone-600 min-[1100px]:bg-gradient-to-br from-stone-500 via-stone-800 to-bg-black">
      ...
      <div className="min-[1100px]:min-w-[35%] flex-1 min-[1100px]:flex-0 h-[60%] rounded-[20px] p-[1px] z-0 relative bg-stone-600 min-[1100px]:bg-gradient-to-bl from-stone-500 via-stone-800 to-bg-black">
        <div className="absolute w-[calc(100%-2px)] h-[calc(100%-2px)] top-[1px] bg-black left-[1px] rounded-[20px] z-0" />
